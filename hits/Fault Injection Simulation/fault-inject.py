...
def in_loop(target_line):
    if 86 < target_line < 98:
        return '1'
    elif 109 < target_line < 134:
        return '1'
    elif 157 < target_line < 169:
        return '1'
    elif 180 < target_line < 205:
        return '1'
    elif 361 < target_line < 372:
         return '1'
    elif 384 < target_line < 405:
         return '1'
    elif 430 < target_line < 441:
         return '1'
    elif 453 < target_line < 474:
         return '1'
    else:
        return '0'
...
def get_kernel_name_and_param(target_line):
    ...
    param2 = ''
    kernel_name = 'null'
    if  14 < target_line < 213 :
        kernel_name = '_Z11hits_gatherPKfS0_PfS1_PKiS3_S3_S3_S3_iPii'  	
        param1 = '_Z11hits_gatherPKfS0_PfS1_PKiS3_S3_S3_S3_iPii_param_10'
        param2 = '_Z11hits_gatherPKfS0_PfS1_PKiS3_S3_S3_S3_iPii_param_11'
    if  215 < target_line < 296 :
        kernel_name = '_Z10hits_applyPfS_S_S_PKiiPiS2_S2_i'
        param1 = '_Z10hits_applyPfS_S_S_PKiiPiS2_S2_i_param_8'
        param2 = '_Z10hits_applyPfS_S_S_PKiiPiS2_S2_i_param_9'
    if  298 < target_line < 477 :
        kernel_name = '_Z12hits_scatterPiiPKiS1_S1_S1_S_S_S_i'
        param1 = '_Z12hits_scatterPiiPKiS1_S1_S1_S_S_S_i_param_8'
        param2 = '_Z12hits_scatterPiiPKiS1_S1_S1_S_S_S_i_param_9'
    ...
    try:
        with open(file_path, 'r') as file:
            ...
            if lines:
                ...
                values = line.split(':')
                return int(values[0])  # Return the first value as an integer
            else:
    ...
    try:
        with open(file_path, 'r') as file:
            ...
            for i in range(0, len(lines), 2):
                ...
                values1 = line1.split(':')
                if len(values1) == 2:
                    first_num, second_num = int(values1[0]), int(values1[1]) # 迭代轮次、活跃线程数
                    if first_num == iter:
                        values2=line2.split(',')
