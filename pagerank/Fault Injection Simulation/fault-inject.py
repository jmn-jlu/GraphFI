...
def in_loop(target_line):
    if 78 < target_line < 96:
        return '1'
    elif 107 < target_line < 156:
        return '1'
    elif 283 < target_line < 294:
        return '1'
    elif 306 < target_line < 327:
        return '1'
    else:
        return '0'
...
def get_kernel_name_and_param(target_line):
    ...
    param2 = ''
    kernel_name = 'null'
    if  14 < target_line < 164 :
        kernel_name = '_Z15pagerank_gatherPfPKfPKiS3_S3_S3_iPii'  	
        param1 = '_Z15pagerank_gatherPfPKfPKiS3_S3_S3_iPii_param_7'
        param2 = '_Z15pagerank_gatherPfPKfPKiS3_S3_S3_iPii_param_8'
    if  166 < target_line < 224 :
        kernel_name = '_Z14pagerank_applyPfPKfPKiiPiS4_i'
        param1 = '_Z14pagerank_applyPfPKfPKiiPiS4_i_param_5'
        param2 = '_Z14pagerank_applyPfPKfPKiiPiS4_i_param_6'
    if  226 < target_line < 330 :
        kernel_name = '_Z16pagerank_scatterPiiPKiS1_S_S_i'
        param1 = '_Z16pagerank_scatterPiiPKiS1_S_S_i_param_5'
        param2 = '_Z16pagerank_scatterPiiPKiS1_S_S_i_param_6'
...
def get_iter_sum(file_path):    
    try:
        with open(file_path, 'r') as file:
            ...
            if lines:
                line = lines[-2].strip()  # Get the second-to-last line and strip any extra spaces
                values = line.split(':')  # Split the line by the colon
                return int(values[0])  # Return the first part as an integer
            else:
                print("The file is empty")  # Handle case when the file has no content
    except FileNotFoundError:
        print(f"File not found: {file_path}")  # Handle case when the file cannot be found
    except ValueError:
        print("The second-to-last line is not an integer")  # Handle case when the line doesn't contain an integer
        ...
        with open(file_path, 'r') as file:
            ...
            for i in range(0, len(lines), 2):
                ...
                if len(values1) == 2:
                    ...
                    if first_num == iter:
                        values2=line2.split(',')
                        id = random.randint(0,second_num-1) # 随机选择注错id
