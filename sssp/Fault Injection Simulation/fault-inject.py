    ...
    for line in f.readlines():
        ...
        if len(split_line) > 2:
            ...
            if split_line[0] == str(target_line):
                ...
                ins_str = split_line[1] # cvt.s64.s32
                des_str = split_line[2] # %rd2,


                ins_str_list = ins_str.split('.')  # cvt s64 s32
                # mov u32
...
def in_loop(target_line):
    if 85 < target_line < 128:
        return '1'
    elif 135 < target_line < 151:
        return '1'
    elif 277 < target_line < 288:
        return '1'
    else:
        return '0'
...
def get_kernel_name_and_param(target_line):
    ...
    param2 = ''
    kernel_name = 'null'
    if  14 < target_line < 160:
        kernel_name = '_Z11sssp_gatherPiS_PKiS1_S_iiS_i'  	
        param1 = '_Z11sssp_gatherPiS_PKiS1_S_iiS_i_param_7'
        param2 = '_Z11sssp_gatherPiS_PKiS1_S_iiS_i_param_8'
    if  162 < target_line < 226 :
        kernel_name = '_Z10sssp_applyPiS_S_S_iiS_i'
        param1 = '_Z10sssp_applyPiS_S_S_iiS_i_param_6'
        param2 = '_Z10sssp_applyPiS_S_S_iiS_i_param_7'
    if  228 < target_line < 291 :
        kernel_name = '_Z12sssp_scatterPKiS0_PiS1_iS1_i'
        param1 = '_Z12sssp_scatterPKiS0_PiS1_iS1_i_param_5'
        param2 = '_Z12sssp_scatterPKiS0_PiS1_iS1_i_param_6'        
